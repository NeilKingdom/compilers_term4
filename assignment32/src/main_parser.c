...
extern BufferPointer stringLiteralTable; /* This buffer is used as a repository for string literals */
extern int errorNumber;     /* Run-time error number = 0 by default (ANSI) */
